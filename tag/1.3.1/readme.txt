...
Payhero offers the SPS (Swift Payment Service) for users in the Kenyan market, which allows them to receive payments from MPESA (a mobile payment service in Kenya) to their bank account, pay bills, or pay till numbers. The Payhero SPS plugin for WordPress and WooCommerce enables users to easily integrate SPS on their website to receive and process order payments automatically. To use this plugin, users must have an account with Payhero and obtain their credentials to be used in  the Pay Hero Store menu in WordPress after installing and activating the plugin. This plugin is a convenient and secure way for users in the Kenyan market to receive payments through MPESA and streamline the checkout process on their WooCommerce website.

== Description ==

Pay hero offers the SPS service for users in the Kenyan market for now. It enables them to receive payments from MPESA to bank, pay bills or till numbers. This plugin enables you to integrate SPS on your wordpress woocommerce website to receive and process order payments automatically.
...
You can contact us via +254765344101 or email payherokenya@gmail.com
