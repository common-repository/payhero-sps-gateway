...
<div class="wrap">
    ...
    <div class="notice notice-info is-dismissible">
        <p><span class="dashicons dashicons-store"></span> Provide your store information below. This information will
            ...
            marked with an asteric * are required. You neeed an account on Payhero SPS <a href="https://payherokenya.com/sps-app" target="_blank">Login/Sign Up</a> To get your Username and API Key</p>
    </div>
    ...
    <form method="post" action="">
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <select name="payment_success_status" id="payment_success_status">
                        ...
                        <option value="completed" <?php if (get_option('ph_payment_success_status')=="completed") { echo
            ...
            <tr>
                ...
                <td><input type="text" name="sps_username" value="<?php echo esc_html(get_option('ph_sps_username')); ?>"
                        id="sps_username" class="regular-text" placeholder="Enter your SPS username" /></td>
            </tr>
            <!-- SPS API Key form -->
            <tr>
                <th scope="row"><label for="sps_api_key">SPS API Key</label></th>
                <td><input type="password" name="sps_api_key" value="<?php echo esc_html(get_option('ph_sps_api_key')); ?>"
                        id="sps_api_key" class="regular-text" placeholder="Enter your SPS API key" /></td>
            </tr>
...
<div class="wrap">
    ...
    if ($Status == 'Sucess') {
        ...
        echo '<div class="alert alert-danger d-flex align-items-center" role="alert">
            ...
            <?php if ($Status == 'Sucess') { ?><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
